...
public class Main {
    ...
    public static void mainMenu(){
        ...
        int choice = 0;
        String again =""; // declare and initialise variables to hold value for users choices
        ...
        do{//use do loop i.e. first part of code will always run. Condition at end of loop will be checked to see if the loop is to be repeated
            ...
            if (choice ==3){ //if usr chooses option 3 call method displayTotal(ArrayList price will be passed to this method)
                displayTotal(price);
            }
    ...
    //declare and create method that will sort the game titles into alphabetical order (ArrayList title will be passed to this method)
    ...
    {
        double total = 0;//declare and initialise local variable to hold value of all game prices

        for(double i: price){//use for each loop i.e. for each item in ArrayList price......

            total = total + i;//....calculate the total price of all items contained in the ArrayList price and assign value to variable total
        }
